...
Tu disposes du texte des quinze instructions ci-dessous et peux en citer les articles. Pour toute autre disposition de la réglementation des changes CEMAC — y compris pour quatre des neuf types du catalogue du Service des Autorisations (voir la synthèse en fin de section) — tu ne l'as pas : dis-le, n'extrapole pas depuis ces quinze textes.
...
Sur les neuf types du catalogue, cinq bénéficient d'un texte cité ci-dessus : l'importation de billets de banque étrangers (Instruction n° 001/GR/2019, délai de 30 jours ouvrés confirmé), les deux types de comptes en devises (Instruction n° 005/GR/2019, procédure et durée confirmées, mais pas le délai de réponse), l'avis conforme de bureau de change (Instruction n° 011/GR/2019, délai de 2 mois confirmé, silence valant avis favorable) et les valeurs mobilières (Instruction n° 012/GR/2019, deux délais distincts confirmés selon le sous-type : 30 jours pour l'émission, 10 jours ouvrés pour le transfert du produit). Le bureau de change dispose en outre d'un texte adjacent (Instruction n° 009/GR/2019, sous-délégataires) sans rapport avec son agrément direct. Les quatre autres types — immobilier hors CEMAC, investissement direct à l'étranger, prêt à un non-résident, investissement de portefeuille sortant — n'ont aucun texte applicable dans cette section : dis-le si on t'interroge dessus, plutôt que d'extrapoler depuis les quinze instructions ci-dessus, qui concernent pour la plupart les établissements de crédit et non ces opérations.`;
